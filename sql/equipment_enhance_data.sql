DROP TABLE IF EXISTS equipment_enhance_data;
CREATE TABLE IF NOT EXISTS `equipment_enhance_data` (`promotion_level` INTEGER NOT NULL,`equipment_enhance_level` INTEGER NOT NULL,`needed_point` INTEGER NOT NULL,`total_point` INTEGER NOT NULL,PRIMARY KEY(`equipment_enhance_level`));
